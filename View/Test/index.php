...
<body>
  ...
  <header class="navbar">
    ...
    <nav class="nav-links">
      ...
      <?php if ($usuario_logueado): ?>
        <a href="panel_usuario.php">Hola, <?php echo htmlspecialchars($nombre_usuario); ?></a>
  ...
  <main class="main-section">
    ...
    <section class="categories">
        ...
        <div class="category" data-filter="dating">💘 Citas</div>
    ...
    <section class="filters">
        ...
        <div class="filter-buttons">
            ...
            <button data-filter="music">Música</button>
            <button data-filter="gastronomy">Gastronomía</button>
        </div>
    </section>
